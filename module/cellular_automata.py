...
Original file is located at
    https://colab.research.google.com/drive/1D8lI7bbN2DhUjW9pwFwNG1DeRc5-EFun
"""
...
class CellularAutomataModel:
    ...
    def cellular_automata_step(self, current_grid: np.ndarray, wind_dir="무풍") -> np.ndarray:
        ...
        # 불어오는 방향의 반대편(바람을 타고 불길이 닥치는 방향) 이웃의 영향력을 키웁니다.
        ...
        for y in range(self.height):
            for x in range(self.width):
                ...
                if valid_neighbors > 0:
                    ...
                    # [상태 전이 규칙 규칙] 이웃의 평균 위험도가 임계값을 넘으면 내 위험도 1단계 상승
